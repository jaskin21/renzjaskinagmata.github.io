export default [
  ...
  {
    name: 'React Native',
    logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/reactnative/reactnative-original-wordmark.svg',
  },
  {
    name: 'Node.js',
  ...
  {
    name: 'AWS Lambda',
    logo: 'https://img.icons8.com/?size=100&id=Y9Kxy8Xl1id8&format=png&color=000000',
  },
  {
    name: 'JavaScript',
